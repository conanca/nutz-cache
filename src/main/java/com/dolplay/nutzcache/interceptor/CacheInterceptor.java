...
public class CacheInterceptor implements MethodInterceptor {
	...
	protected void cacheReturn(String cacheKey, InterceptorChain chain, Method method, Cache cacheAn) throws Throwable {
		...
		String newThreadStr = cacheProp.get("cache-stringSetUseNewThread");
		newThread = Strings.isEmpty(newThreadStr) ? CacheConfig.STRING_ETERNAL_CACHE_KEY_SET_IS_VALID : Boolean
