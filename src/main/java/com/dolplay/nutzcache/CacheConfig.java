...
public class CacheConfig {
	...
	public static final boolean StringEternalCacheKeySetIsValid = true;
	public static final boolean ZsetEternalCacheKeySetIsValid = true;
	public static final String String_Eternal_Cache_KeySet_Name = "nutz-cache:StringEternalCacheKeySet";
	public static final String Zset_Eternal_Cache_KeySet_Name = "nutz-cache:ZsetEternalCacheKeySet";
